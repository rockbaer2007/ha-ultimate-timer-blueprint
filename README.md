...
| Idle | Running | Done |
|------|--------|------|
| ![Idle](docs/preview_idle1.png) | ![Running](docs/preview_running1.png) |# ⏱️ Ultimate Timer V3.2.4 FINAL CLEAN
...
| Idle | Running | Done |
|------|--------|------|
| ![Idle](docs/preview_idle.png) | ![Running](docs/preview_running.png) | ![Done](docs/preview_done.png) |# ⏱️ Ultimate Timer V3.2.4 FINAL CLEAN
...
| Idle | Running | Done | Started
|------|--------|------|
| ![Idle](docs/preview_idle1.png) | ![Running](docs/preview_running1.png) | ![Done](docs/preview_done1.png) | ![Done](docs/preview_started.png) |
